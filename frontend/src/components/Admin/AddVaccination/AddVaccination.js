...
class AddVaccination extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    for (let disease of this.state.selectedDiseases) {
      listOfIds.push(this.state.diseaseData.find(element => element.diseaseName === disease).diseaseId);
    }
            ...
            <div className="row" style={{ padding: "120px" }}>
              ...
              <div className="col col-sm-6">
                ...
                <Form onSubmit={this.handleSubmit} className="form-stacked">
                    ...
                    <Row>
                      ...
                      <Col>
                        <FormGroup>
                          ...
                          {this.state.diseaseError ? <span style={{ color: "red" }}>Error fetching diseases</span> : <Select style={{ width: 'inherit' }} multiple value={this.state.selectedDiseases}
                            ...
                            {this.state.diseaseData.map((element, index) =>
                              <MenuItem key={index} value={element.diseaseName}>
                                <Checkbox checked={this.state.selectedDiseases.indexOf(element.diseaseName) > -1} />
                                <ListItemText primary={element.diseaseName} /></MenuItem>
                            )}
                          </Select>}
                        </FormGroup>
                      </Col>
                  ...
                  <FormGroup >
                    <center>
                      <Button type="submit" disabled={this.state.diseaseError || this.state.selectedDiseases.length === 0} color="btn btn-info">
                        Create Vaccination
                      </Button>
                    </center>
                  </FormGroup>
